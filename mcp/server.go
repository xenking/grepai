...
func (s *Server) handleSearch(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	if err != nil {
		if s.projectRoot == "" {
			...
			return mcp.NewToolResultError("grepai_search requires a project or workspace context; start mcp-serve from a grepai project, pass the workspace parameter, start with --workspace, or run grepai init / grepai workspace create"), nil
		}
